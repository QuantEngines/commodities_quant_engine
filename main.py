...
def _live_state_payload(results: Dict[str, Any], poll_timestamp: datetime, data_mode: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "directional_bias": suggestion.directional_bias,
        "entry_quality": suggestion.entry_quality,
        "category": suggestion.final_category,
        "trade_recommendation": suggestion.trade_recommendation,
        "confidence": round(float(suggestion.confidence_score), 4),
        "directional_confidence": round(float(suggestion.directional_confidence or suggestion.confidence_score), 4),
        "tradeability_confidence": round(float(suggestion.tradeability_confidence or suggestion.confidence_score), 4),
...
def persist_live_observation(
    ...
    payload = {
        ...
        "directional_confidence": _round_optional(suggestion.directional_confidence, digits=6),
        "tradeability_confidence": _round_optional(suggestion.tradeability_confidence, digits=6),
        "data_quality_confidence": _round_optional(suggestion.data_quality_confidence, digits=6),
        ...
        "component_contributions": dict(suggestion.component_contributions or {}),
        "dominant_component": suggestion.dominant_component,
        ...
        "key_drivers": (suggestion.supportive_signals or suggestion.key_supporting_drivers)[:3],
        "contradictory_drivers": (suggestion.contradictory_signals or suggestion.key_contradictory_drivers)[:3],
        "principal_risks": (suggestion.key_risks or suggestion.principal_risks)[:3],
